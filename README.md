...
- [Solitaire](https://github.com/PRDicta/Solitaire-for-Agents) (`PRDicta`) ![](https://img.shields.io/github/stars/PRDicta/Solitaire-for-Agents.svg?style=social) Identity infrastructure for AI agents with evolving behavioral profiles, experiential memory, and self-correcting retrieval. Local-first, model-agnostic.
